                ...
                <div class="content">
                    <div class="reply_wirte">
                        <div class="wirte_wrap">
                            <div class="wirte_box">
                                <span class="boX_text"><textarea class="reply_txt" name="reply_txt" placeholder="댓글을 입력하세요..."></textarea></span>
                                <button type="button" class="red_btn reply_btn">등록</button>
                            </div>
                        </div>
                        <div class="reply_box"><p class="reply_input">댓글을 입력하세요.</p></div>
                    </div>
                </div>
            </div>
        </div>
